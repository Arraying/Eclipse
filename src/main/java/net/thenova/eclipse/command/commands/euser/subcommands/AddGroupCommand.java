 ...
 */
public final class AddGroupCommand extends AbstractSub {

    /**
     * Creates the command.
     */
    public AddGroupCommand() {
        super("addgroup", Arguments.Type.USER, Arguments.Type.GROUP);
    }
    ...
    protected void handle(Arguments arguments) {
        arguments.getUser(0).addGroup(arguments.getGroup(1));
        arguments.getContext().reply(new MessageResponse("The user has been added to the group."));
    }
