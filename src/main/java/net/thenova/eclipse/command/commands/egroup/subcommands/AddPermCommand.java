 ...
 */
public final class AddPermCommand extends AbstractSub {

    /**
     * Creates the command.
     */
    public AddPermCommand() {
        super("addperm", Arguments.Type.GROUP, Arguments.Type.PERMISSION);
    }
    ...
    protected void handle(Arguments arguments) {
        arguments.getGroup(0).addPermission(arguments.getPermission(1));
        arguments.getContext().reply(MessageResponse.PERMISSION_ADDED);
    }
