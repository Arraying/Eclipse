 ...
 */
public final class SetGroupCommand extends AbstractSub {

    /**
     * Creates the command.
     */
    public SetGroupCommand() {
        super("setgroup", Arguments.Type.USER, Arguments.Type.GROUP);
    }
    ...
    protected void handle(Arguments arguments) {
        arguments.getUser(0).setGroup(arguments.getGroup(1));
        arguments.getContext().reply(new MessageResponse("The user's group has been set."));
    }
