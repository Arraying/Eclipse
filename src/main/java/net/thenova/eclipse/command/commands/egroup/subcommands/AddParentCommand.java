 ...
 */
public final class AddParentCommand extends AbstractSub /*AbstractCommand*/ {

    /**
     * Creates the command.
     */
    public AddParentCommand() {
        super("addparent", Arguments.Type.GROUP, Arguments.Type.PARENT);
    }
    ...
    protected void handle(Arguments arguments) {
        arguments.getGroup(0).addParent(arguments.getGroup(1));
        arguments.getContext().reply(new MessageResponse("The parent group has been added."));
    }
